/*
 * $Id: configure.h,v 8.7 1997/11/12 05:00:52 ksb Exp $
 ...
 * BIN{CHGRP,LS,MKDIR,RANLIB,STRIP}
 */
...
#endif
#if !defined(BINSTRIP)
#if defined(FREEBSD) || defined(NETBSD) || defined(LINUX) || defined(BSDI)
...
#if BSD > 42 || defined(HPUX) || defined(SUN3)||defined(SUN4)||defined(IBMR2)
