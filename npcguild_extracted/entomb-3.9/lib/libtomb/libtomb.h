/* $Id: libtomb.h,v 3.35 2000/07/31 15:06:28 ksb Exp $
...
#define HAS_GETMNT	1
#endif
#if SUN3 || SUN4 || SUN5 || S81 || NEXT2 || HPUX8 || HPUX9 || LINUX
...
#define HAVE_UNIONWAIT	(defined(VAX780)||defined(VAX8800)||defined(SUN3)||defined(SUN4)||defined(S81)||defined(NEXT2)||defined(FREEBSD)||defined(NETBSD)||defined(BSDI))
#endif
...
#define HAS_DIRENT      (defined(EPIX)||defined(SUN5)||defined(LINUX))
#endif

#if !defined(DIRENT)
#if defined(IBMR2) || defined(EPIX) || defined(SUN5) || defined(LINUX)
...
#define NEED_PROTO_DEFINE (defined(HPUX9)||defined(LINUX))
#endif

#if !defined(USE_STATFS)
#define USE_STATFS	(defined(IBMR2)||defined(NEXT2)||defined(FREEBSD)||defined(NETBSD)||defined(LINUX)||defined(BSDI))
#endif	/* need to get file system type */

#if !defined(USE_STRINGS)
#define USE_STRINGS	(!(defined(SUN5) || defined(SUN4)))
#endif

#if !defined(USE_SYSSYSCALL)
#define USE_SYSSYSCALL	(defined(SUN5)||defined(NETBSD)||defined(FREEBSD)||defined(BSDI))
#endif
...
#define HAVE_STRERROR	(defined(NEXT2)||defined(SUN5)||defined(IRIX)||defined(FREEBSD)||defined(BSDI)||defined(LINUX))
#endif
...
#define USE_SAVED_UID	(defined(HPUX8) || defined(HPUX9))
#endif
