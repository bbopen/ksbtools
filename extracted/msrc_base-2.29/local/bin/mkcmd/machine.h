/* $Id: machine.h,v 8.17 2008/07/09 19:25:42 ksb Exp $
 */
...
#if !defined(DEFDIR)
#define DEFDIR	"/usr/local/lib/mkcmd:/usr/local/share/mkcmd:/usr/local/lib/mkcmd/type:/usr/local/share/mkcmd/type"
#endif
...
#if IBMR2||PTX||FREEBSD||OPENBSD||MSDOS||ULTRIX||BSDI||HPUX10
#define USE_STDLIB	1
#else
#define USE_STDLIB	0
#endif
...
#define HAVE_STRDUP	(defined(SUN5)||defined(SUN4)||defined(SUN3)||defined(NETBSD)||defined(AMIGA)||defined(HPUX)||defined(IRIX5)||defined(IRIX6)||defined(IBMR2)||defined(FREEBSD)||defined(OPENBSD)||defined(PARAGON)||defined(MSDOS)||defined(CONSENSYS)||defined(BSDI)||defined(LINUX))
#endif
...
#if PTX||NEXT2||IBMR2||HPUX||SUN5||NETBSD||PARAGON||MSDOS||FREEBSD||IRIX||CONSENSYS||LINUX||OPENBSD
...
#if PTX||IBMR2||NEXT2||defined(HPUX11)
...
#define NEED_MALLOC_EXTERN	(!USE_MALLOC_H && !defined(NEXT2) && !defined(IRIX) && !defined(BSDI) && !defined(HPUX9) &&!defined(FREEBSD) &&!defined(OPENBSD) && !(defined(LINUX) && (HOSTOS >= 40000)) )
#endif
...
#define HAVE_MKSTEMP	(defined(OPENBSD)||defined(FREEBSD)||defined(OPENBSD))
#endif

#if !defined(HAVE_MKSTEMPS)
#define HAVE_MKSTEMPS	(defined(OPENBSD)||defined(FREEBSD)||defined(OPENBSD))
#endif
